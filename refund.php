...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $reasonForRefund = $_POST["reasonForRefund"];

    // Set the default status to "pending"
    $defaultStatus = "Pending";

    // Insert data into tb_refund with refund_date and status
    $sql = "INSERT INTO tb_refund (order_id, gcash_name, gcash_number, transaction_amount, reason, refund_date, status)
            VALUES ('$order_id','$gcashName', '$gcashNumber', '$transactionAmount', '$reasonForRefund', NOW(), '$defaultStatus')";
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            <div class="content">
                ...
                <?php
                // Check if $message is set and is an array before using foreach
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Your refund request has been submitted. Thank you!</p>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                                        ...
                                                        transactionAmountInput.addEventListener('input', function() {
                                                            ...
                                                            if (!transactionAmountPattern.test(inputValue)) {
                                                                ...
                                                                transactionAmountNote.style.display = 'none'; // Hide note if the pattern matches
                                                                    ...
                                                                    <!-- Adding a hidden field for order_id -->
                                ...
                                <script>
                                    // Use jQuery or vanilla JavaScript to trigger the modal
                                    $(document).ready(function() {
                                        // Check if the message array contains a success message
                                        <?php if (in_array('Record added successfully', $message)) : ?>
