                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Customer Concerns</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Customer Concerns</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table dt-responsive nowrap w-100" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $select_users = mysqli_query($conn, "SELECT * FROM `contacts`");
