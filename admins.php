                                ...
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            ...
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Admins
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table dt-responsive nowrap w-100" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $select_users = mysqli_query($conn, "SELECT * FROM `tb_admin`");
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td class="table-action">
                                                                <button type="button" class="btn btn-dark btn-rounded" data-bs-toggle="modal" data-bs-target="#info_<?php echo $row['admin_id']; ?>">
                                                                ...
                                                                <button class="btn btn-danger btn-rounded delete-btn" data-user-id="<?php echo $row['admin_id']; ?>"><i class="mdi mdi-delete"></i></button>
                                                            </td>

                                                            <!-- Info MODAL -->
                                                            <div class="modal fade" id="info_<?php echo $row['admin_id']; ?>" tabindex="-1" aria-labelledby="deleteConfirmationModalLabel" aria-hidden="true">
