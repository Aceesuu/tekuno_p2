    ...
    <div class="content-page">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Profit Reports</a></li>
                                    <li class="breadcrumb-item active">Reports</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Profit Reports</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
        ...
        <script>
            function searchOrders() {
                ...
                xhttp.open("GET", "search2.php?startDate=" + startDate + "&endDate=" + endDate, true);
                xhttp.send();
            }
        </script>
