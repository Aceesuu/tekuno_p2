            ...
            <div class="grid-item ui">
              <div class="gallery-image">
                ...
                <div class="img-overlay">
                  <div class="img-description">
                    <center>
                      <h3>Semento (Per Sack 40 Kilos)</h3>
                    </center>
                    <center>
                      <h5>₱204.00</h5>
                    </center>
            ...
            <div class="grid-item appdev">
              <div class="gallery-image">
                ...
                <div class="img-overlay">
                  <div class="img-description">
                    <center>
                      <h3>Claw Hammer Wooden Handle</h3>
                    </center>
                    <center>
                      <h5>₱160.00</h5>
                    </center>
              ...
              <div class="bottom-footer">
                <div class="copyright">
                  <p class="text">
                    ...
                    <span class="split-text" data-text="FORUM"><a href="" class="tekuno-link">TEKUNO</a>
