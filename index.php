...
<html lang="en">
  <head>
    ...
    <link
      ...
      <link rel="stylesheet" href="./css/des4.css" />
            ...
            <section class="portfolio section" id="portfolio">
              ...
              <div class="container">
                ...
                <div class="section-body">
                  <div class="filter">
                    <button class="filter-btn active" data-filter="*">PRODUCTS</button>
                  </div>
                  <div class="grid">
                    <div class="grid-item logo-design">
                      <div class="gallery-image">
                        <img src="./img/portfolio/coco1.png" alt="" />
                        <div class="img-overlay">
                          <div class="img-description">
                            <center><h3>COCO LUMBER</h3></center>
                            <center><h5>₱35.00 - 169.00</h5></center>
                          </div>
                  <a href="javascript:void(0);" onclick="addToCartBtn()" class="btn">Add to Cart</a>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="gallery-image">
                        ...
                        <div class="img-overlay">
                          <div class="img-description">
                            ...
                            <center><h5>₱45.00 - ₱50.00</h5></center>
                          </div>
                  <a href="javascript:void(0);" onclick="addToCartBtn()" class="btn">Add to Cart</a>
                        </div>
                      </div>
                      ...
                      <div class="gallery-image">
                        ...
                        <div class="img-overlay">
                          <div class="img-description">
                            ...
                            <center><h5>₱10.00 - ₱500.00</h5></center>
                          </div>
                  <a href="javascript:void(0);" onclick="addToCartBtn()" class="btn">Add to Cart</a>
                        </div>
                      </div>
                    ...
                    <div class="grid-item ui">
                      <div class="gallery-image">
                        <img src="./img/portfolio/bu1.png" alt="" />
                        <div class="img-overlay">
                          <div class="img-description">
                          <center><h3>Semento (Per Sack 40 Kilos)</h3></center>
                        <center><h5>₱204.00</h5></center>
                          </div>
                  <a href="javascript:void(0);" onclick="addToCartBtn()" class="btn">Add to Cart</a>
                        </div>
                      </div>
                  ...
                  <a href="javascript:void(0);" onclick="addToCartBtn()" class="btn">Add to Cart</a>
                    ...
                    <div class="grid-item appdev">
                      <div class="gallery-image">
                        <img src="./img/portfolio/ham1.png" alt="" />
                        <div class="img-overlay">
                          <div class="img-description">
                          <center><h3>Claw Hammer Wooden Handle</h3></center>
                         <center><h5>₱160.00</h5></center>
                          </div>
                  <a href="javascript:void(0);" onclick="addToCartBtn()" class="btn">Add to Cart</a>
                        </div>
                      </div>
                    ...
                    <div class="grid-item logo-design">
                      <div class="gallery-image">
                        <img src="./img/portfolio/nails1.png" alt="" />
                        <div class="img-overlay">
                          <div class="img-description">
                          <center><h3>Nails (Per Kilo)</h3></center>
                        <center><h5>₱50.00 - ₱100.00</h5></center>
                          </div>
                  <a href="javascript:void(0);" onclick="addToCartBtn()" class="btn">Add to Cart</a>
                        </div>
                      </div>
                    ...
                    <div class="grid-item appdev ui">
                      <div class="gallery-image">
                        <img src="./img/portfolio/hl1.png" alt="" />
                        <div class="img-overlay">
                          <div class="img-description">
                          <center><h3>Hollow Blocks</h3></center>
                        <center><h5>₱19.00 - ₱25.00</h5></center>
                          </div>
                  <a href="javascript:void(0);" onclick="addToCartBtn()" class="btn">Add to Cart</a>
                        </div>
                      </div>
          ...
          <div class="copyright">
            <p class="text">
              ...
              <span class="split-text" data-text="FORUM"><a
                href="" class="tekuno-link">TEKUNO</a>
