...
$sql = "SELECT COUNT(*) AS customer_count FROM tb_user WHERE is_admin = 0";
...
$sql = "SELECT COUNT(*) AS order_count FROM tb_order";
$result = $conn->query($sql);
...
// SQL query to count the orders
$sql = "SELECT COUNT(*) AS admin_count FROM tb_user WHERE is_admin = 1";
$result = $conn->query($sql);
