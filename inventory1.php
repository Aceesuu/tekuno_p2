...
<body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="table dt-responsive nowrap w-100" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $select_products = mysqli_query($conn, "SELECT * FROM `tb_stock` WHERE qty > 0");
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="POST" action="crud_inventory.php" enctype="multipart/form-data">
                                                                        <input type="hidden" name="update_p_id" value="<?php echo $row['stock_id']; ?>">
                                                                        <div class="mb-3 row">
                                                                            <label class="col-sm-2 col-form-label">Product Name</label>
                                                                            <div class="col-sm-10">
                                                                                <input type="text" class="form-control" name="update_p_name" readonly value="<?php echo $row['name']; ?>">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="mb-3 row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <input type="text" class="form-control" name="update_p_price" readonly value="<?php echo $row['supplier_price']; ?>">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="mb-3 row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <input type="text" class="form-control" name="update_p_sup" readonly value="<?php echo $row['price']; ?>">
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <form action="crud_inventory.php" method="post" class="add-product-form" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="p_name" class="form-control" required>
                                                                ...
                                                                <?php
                                                                $sql = "SELECT name, price, supplier_price FROM tb_product";
                                                                $result = mysqli_query($conn, $sql);
                                                                while ($row = mysqli_fetch_assoc($result)) {
                                                                    echo '<option value="' . $row['name'] . '" data-price="' . $row['price'] . '" data-supplier_price="' . $row['supplier_price'] . '">' . $row['name'] . '</option>';
                                                                }
                                                                ?>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" min="1" value="" name="p_sup" id="p_sup" placeholder="Supplier Price" class="form-control" readonly>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="simpleinput" class="form-label">Price</label>
                                                            <input type="number" min="1" value="" name="p_price" id="price" placeholder="Unit Price" class="form-control" readonly>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="simpleinput" class="form-label">Quantity</label>
                                                            <input type="number" min="1" value="" name="p_qty" placeholder="Enter Quantity" class="form-control" required">
                                                        </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
    ...
    <script>
        $(document).ready(function() {
            // Function to update Supplier Price and Price fields when a product is selected
            $('select[name="p_name"]').on('change', function() {
                var selectedOption = $(this).find('option:selected');
                var supplierPrice = selectedOption.data('supplier_price');
                var price = selectedOption.data('price');

                // Update the Supplier Price and Price input fields
                $('#p_sup').val(supplierPrice);
                $('#price').val(price);
            });
        });
    </script>
