                                ...
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            ...
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Admin
                                            </button>
                                        </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="crud_admin.php" method="post" class="add-product-form" enctype="multipart/form-data">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="username" class="form-label"><i class="fas fa-envelope"></i> username</label>
